//https://go.dev/play/p/3eTKIC9YR1C

//how Google uses it: https://go.dev/blog/context
...
func main() {
	...
	go func() {
		...
		// e.g. employee passes ice cream cone to the managers' hand
		ch <- "paper"
	}()
